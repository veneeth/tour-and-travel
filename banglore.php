...
FROM adddetails where addplace='banglore' GROUP BY packageid");
...
<table class="table table-bordered">
        ...
        <?php
...

             {
                 ?>
            <tr>
                <td rowspan="9" align="center" style="vertical-align:middle;"><img src="banglore.jpg" alt="" height=150 width=150></td>
                <td><strong>Place Name:</strong><input type="text" name="name" value="banglore" hidden> <?php echo $row['addplace']; ?></td>
            ...
            <tr>
                <td><strong>Food Amount&nbsp;</strong><input type="number" name="food" value="2500" hidden> Rs:<?php echo $row['foodamount']; ?></td>
            </tr>
             <tr>
                <td><strong>Travelling Amount&nbsp;</strong><input type="number" name="travel" value="2000" hidden> Rs:<?php echo $row['airlinesamount']; ?></td>
            ...
            <tr>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Total:</strong><input type="number" name="total" value="10500" hidden><?php echo $row['totalamount']; ?></td>
            </tr>
            <tr>
