...
FROM adddetails where addplace='goa' GROUP BY packageid");
...
<table class="table table-bordered">
        ...
        <?php
...

             {
                 ?>
            <tr>
                <td rowspan="9" align="center" style="vertical-align:middle;"><img src="goa.jpg" alt="" height=150 width=150></td>
                <td><strong>Place Name:</strong><input type="text" name="name" value="goa" hidden> <?php echo $row['addplace']; ?></td>
            ...
            <tr>
                <td><strong>Stay Amount&nbsp;</strong><input type="number" name="stay" value="10500" hidden> Rs:<?php echo $row['stayamount']; ?></td>
            ...
            <tr>
             ...
             <tr>
                <td><strong>Travelling Amount&nbsp;</strong><input type="number" name="travel" value="10000" hidden> Rs:<?php echo $row['airlinesamount']; ?></td>
            ...
            <tr>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Total:</strong><input type="number" name="total" value="25500" hidden><?php echo $row['totalamount']; ?></td>
            </tr>
            <tr>
