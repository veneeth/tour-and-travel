...
FROM adddetails where addplace='kashmir' GROUP BY packageid");
...
<table class="table table-bordered">
        ...
        <?php
...

             {
                 ?>
            <tr>
                <td rowspan="9" align="center" style="vertical-align:middle;"><img src="kashmir.jpg" alt="" height=150 width=150></td>
                <td><strong>Place Name:</strong><input type="text" name="name" value="kashmir" hidden> <?php echo $row['addplace']; ?></td>
            ...
            <tr>
                <td><strong>No of Days:</strong><input type="number" name="days" value="7" hidden> <?php echo $row['noofdays']; ?>&nbsp;&nbsp;&nbsp;<strong>No of Nights:</strong><input type="number" name="nights" value="6" hidden><?php echo $row['noofnights']; ?></td>
            ...
            <tr>
                <td><strong>Stay Amount&nbsp;</strong><input type="number" name="stay" value="10000" hidden> Rs:<?php echo $row['stayamount']; ?></td>

            </tr>
            <tr>
                <td><strong>Food Amount&nbsp;</strong><input type="number" name="food" value="5000" hidden> Rs:<?php echo $row['foodamount']; ?></td>
            </tr>
             <tr>
                <td><strong>Travelling Amount&nbsp;</strong><input type="number" name="travel" value="25000" hidden> Rs:<?php echo $row['airlinesamount']; ?></td>
            ...
            <tr>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Total:</strong><input type="number" name="total" value="40000" hidden><?php echo $row['totalamount']; ?></td>
            </tr>
            <tr>
