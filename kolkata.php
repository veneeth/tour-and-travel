...
FROM adddetails where addplace='kolkata' GROUP BY packageid");
...
<table class="table table-bordered">
        ...
        <?php
...

             {
                 ?>
            <tr>
                <td rowspan="9" align="center" style="vertical-align:middle;"><img src="kolkata.jpg" alt="" height=150 width=150></td>
                <td><strong>Place Name:</strong><input type="text" name="name" value="kolkata" hidden> <?php echo $row['addplace']; ?></td>
            ...
            <tr>
                <td><strong>No of Days:</strong><input type="number" name="days" value="5" hidden> <?php echo $row['noofdays']; ?>&nbsp;&nbsp;&nbsp;<strong>No of Nights:</strong><input type="number" name="nights" value="4" hidden><?php echo $row['noofnights']; ?></td>
            ...
            <tr>
                <td><strong>Stay Amount&nbsp;</strong><input type="number" name="stay" value="6500" hidden> Rs:<?php echo $row['stayamount']; ?></td>

            </tr>
            <tr>
                <td><strong>Food Amount&nbsp;</strong><input type="number" name="food" value="3000" hidden> Rs:<?php echo $row['foodamount']; ?></td>
            </tr>
             <tr>
                <td><strong>Travelling Amount&nbsp;</strong><input type="number" name="travel" value="8000" hidden> Rs:<?php echo $row['airlinesamount']; ?></td>
            ...
            <tr>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Total:</strong><input type="number" name="total" value="17500" hidden><?php echo $row['totalamount']; ?></td>
            </tr>
            <tr>
