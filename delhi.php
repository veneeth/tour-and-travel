...
FROM adddetails where addplace='delhi' GROUP BY packageid");
...
<table class="table table-bordered">
        ...
        <?php
            ...
            <tr>
                ...
                <td><strong>Place Name:</strong><input type="text" name="name" value="delhi" hidden> <?php echo $row['addplace']; ?></td>
            ...
            <tr>
                <td><strong>Stay Amount&nbsp;</strong><input type="number" name="stay" value="6000" hidden> Rs:<?php echo $row['stayamount']; ?></td>
            ...
            <tr>
             ...
             <tr>
                <td><strong>Travelling Amount&nbsp;</strong><input type="number" name="travel" value="8500" hidden> Rs:<?php echo $row['airlinesamount']; ?></td>
